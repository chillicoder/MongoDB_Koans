...
class AboutCRUD < EdgeCase::Koan
  ...
  def test_replace_document
    ...
    @col.save(doc2)
    assert_equal 1, @col.size, "Collection size is wrong"
    assert_equal doc2, @col.find_one, "Document not updated"
    assert_not_equal doc1, @col.find_one, "Document not updated correctly"
  end
  ...
  def test_update_document
    ...
    assert_not_equal "tuna salad", @col.find_one['type'], "Document not updated correctly"
  end
